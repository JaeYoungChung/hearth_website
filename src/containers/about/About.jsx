    ...
    <div className="About">
      ...
      <div className="section text-center">
        <div className="centered-text">
            ...
            <p>It is here to understand our emotions through self-analyzation, by finding out what each of our distinct cognitive abilities are, from strength to weakness. 
              ...
              Here we focus on 6 intertwined yet individual set of Cognitive Force, which as a sum is
                ...
                <br></br><br></br>
                Focus on controlling and enhancing these 6 aspects and we will shine bright, by becoming the best version of ourselves.</p>
                <br></br><br></br>
