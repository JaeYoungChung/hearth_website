...
function Apps() {
  ...
  const imageData = {
    ...
    5: { src:  harmonize_flame, color: "#FF00FF", text: ["Harmonize", t('apps.interpersonal_skills'),  t("apps.harmonize_intro"), t("apps.harmonize_components"), t("apps.harmonize_are"), t("apps.harmonize_flame")] },
  };
