...
// // //   <table width="100%" cellspacing="0" cellpadding="0" style="background-color: black;">
// // //     <tr>
// // //       <td align="center" style="padding: 20px;">
// // //         <table width="100%" cellspacing="0" cellpadding="0">
// // //           <tr>
// // //             <td align="center" style="padding-bottom: 20px;">
// // //               <img src="cid:result_logo.png" alt="Logo" style="max-width: 200px;"/>
// // //               <p style="color: white; font-size: 4vw;">HEARTH<br/>T E S T</p>
// // //             </td>
// // //           </tr>
// // //           <tr>
// // //             <td align="center" style="color: white;">
// // //               <p style="padding-left: 15%; padding-right: 15%; width:70%; ">{{testResultText}}</p>
// // //             </td>
// // //           </tr>
// // //           <tr>
// // //             <td align="center" style="padding-top: 30px; padding-bottom: 30px;">
// // //               <div id='first-design' style="position: relative; display: inline-block;">
// // //   {{message_html}}
// // // <p class="testCaption" style="color: {{testResultColor}}; font-style: bold; font-size: 35px;">{{testResultCaption}}</p>
// // //               </div>
// // //             </td>
// // //           </tr>
// // //           <tr>
...
// // //                       <tr>
// // //                         <td style="width: 40%; padding-left: 5%; background-color: black; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); color: white;">
...
// // //             <td style="width: {{score1}}%; background-color: #0FF517; height: 10px; border-radius: 5px 0 0 5px;"></td>
...
// // //             <td style="width: {{score2}}%; background-color: #FF00FF; height: 10px; border-radius: 5px 0 0 5px;"></td>
...
// // //           <tr>
// // //             <!-- Green part to show progress -->
// // //             <td style="width: {{score3}}%; background-color: #005CDE; height: 10px; border-radius: 5px 0 0 5px;"></td>
...
// // //           <tr>
// // //             <!-- Green part to show progress -->
// // //             <td style="width: {{score4}}%; background-color: #FFEF00; height: 10px; border-radius: 5px 0 0 5px;"></td>
...
// // //           <tr>
// // //             <!-- Green part to show progress -->
// // //             <td style="width: {{score5}}%; background-color: #00FFFF; height: 10px; border-radius: 5px 0 0 5px;"></td>
...
// // //           <tr>
// // //             <!-- Green part to show progress -->
// // //             <td style="width: {{score6}}%; background-color: #DC143C; height: 10px; border-radius: 5px 0 0 5px;"></td>
...
// // //                       <tr>
// // //                         <td align="center">
// // //   <img src="{{maxImage}}" alt="Maximum Image" title="Max Image" style="display:block;" height="80"/>
// // //   <p>{{maxLabel}}</p>
// // //                           <a href="https://apps.apple.com/us/app/instagram/id389801252?itsct=apps_box_badge&amp;itscg=30200" style="display: inline-block; overflow: hidden; border-radius: 13px; width: 250px; height: 83px;"><img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83&amp;releaseDate=1286323200" alt="Download on the App Store" style="border-radius: 13px; width: 120px; height: 83px;"></a>
// // //                         </td>
// // //                         <td width="20px"></td>
// // //                         <td align="center">
// // //   <img src="{{minImage}}" alt="Minimum Image" title="Logo" style="display:block;" height="80"/>
// // //   <p>{{minLabel}}</p>
// // //                           {{weakData4}}
// // //                         </td>
// // //                       </tr>
...
// // //                 <tr>
// // //                   <td align="center" style="padding-top: 20px;">
// // //                     Get your HEARTH Apps and<br/>Personalize your experience with your HEARTH Code <span style="color: {{testResultColor}}; font-weight: bold;">{{testResultCaption}}</span>
// // //                   </td>
// // //                 </tr>
// // //                 <tr>
...
// // //                     You're receiving this email because you opted-in to receive updates from Hearth.com | Unsubscribe
// // //                   </td>
// // //                 </tr>
// // //                 <tr>
// // //                   <td align="center" style="padding-top: 10px; opacity: 0.7; font-size: 12px;">
// // //                     Vivos Voco Inc. • 29, Hakdongro 68-Gil, Gangnam-Gu, Seoul
// // //                   </td>
// // //                 </tr>
// // //               </table>
// // //             </td>
...
//             emailjs.send('servicenum', 'templatenum', templateParams, 'code')
//             .then((response) => {
//                 console.log('Email sent successfully!', response.status, response.text);
//               })
//               .catch((error) => {
